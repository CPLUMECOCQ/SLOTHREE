...
struct TestParameters {
  ...
  std::string liquidh5file = "bases/liquide/parafac_rank_8.h5";
  std::string solidh5file = "bases/solide/parafac_rank_8.h5";
...
int main(int argc, char* argv[]) {
  ...
  Calphad_Problem<PARAFAC2SLOTHInterface<mfem::Vector, 3>, VARS, PST> ia_problem(
